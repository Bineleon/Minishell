...
/*   Updated: 2024/12/12 21:38:50 by elilliu          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//     t_bool is_file_context = false;
	// Indique si on attend un fichier après une redirection
...
//             // Si c'est une redirection,
	// le token suivant est un fichier/opérande
...
//                 current->is_cmd = command_found;
	// True si une commande a été trouvée
//             }
